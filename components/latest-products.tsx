...
export function LatestProducts() {
  ...
  return (
    <section id="latest-products" className="relative min-h-[600px] overflow-hidden">
      {/* Background Image */}
      ...
      <div className="relative container mx-auto px-4 py-20 z-10">
        ...
        <div className="text-center">
          ...
          >
            Inofinity Research & Development Pvt Ltd has taken the initiative of placing 
            innovative products at various public community areas like Airport, Railway 
            station to facilitate public health and safety.
          </motion.p>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-20">
        <svg viewBox="0 0 1440 100" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
          <path d="M0 50L48 45.8C96 41.7 192 33.3 288 29.2C384 25 480 25 576 33.3C672 41.7 768 58.3 864 62.5C960 66.7 1056 58.3 1152 50C1248 41.7 1344 33.3 1392 29.2L1440 25V100H1392C1344 100 1248 100 1152 100C1056 100 960 100 864 100C768 100 672 100 576 100C480 100 384 100 288 100C192 100 96 100 48 100H0V50Z" fill="rgba(59, 130, 246, 0.3)"/>
          <path d="M0 75L48 70.8C96 66.7 192 58.3 288 54.2C384 50 480 50 576 58.3C672 66.7 768 83.3 864 87.5C960 91.7 1056 83.3 1152 75C1248 66.7 1344 58.3 1392 54.2L1440 50V100H1392C1344 100 1248 100 1152 100C1056 100 960 100 864 100C768 100 672 100 576 100C480 100 384 100 288 100C192 100 96 100 48 100H0V75Z" fill="rgba(147, 197, 253, 0.5)"/>
        </svg>
      </div>
    </section>
  )
