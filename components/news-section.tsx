...
const newsItems = [
  ...
  },
  {
    ...
    description:
      'A Herculean task " Train the trainers in medical simulation" started today at KAABEEL Simulation and skill upgradation center . Aim is to create at least 100 trainers for 28 simulation modules at KIMS within next 2 years. Focus is on developing a simulation based pedagogy and innovatively approached simulation-based faculty development program to fill…',
